<?php
namespace Komma\Facturae;

use Komma\Facturae\FacturaeTraits\PropertiesTrait;
use Komma\Facturae\FacturaeTraits\UtilsTrait;
use Komma\Facturae\FacturaeTraits\SignableTrait;
use Komma\Facturae\FacturaeTraits\ExportableTrait;
